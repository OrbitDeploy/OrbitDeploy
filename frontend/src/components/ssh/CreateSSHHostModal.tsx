...
import type { SSHHostRequest } from '../../types/remote'

interface CreateSSHHostModalProps {
  isOpen: boolean
  onClose: () => void
...
const CreateSSHHostModal: Component<CreateSSHHostModalProps> = (props) => {
  const { t } = useI18n()
...
export default CreateSSHHostModal
